...
/**
 * These tests are supposed to test part 1 and 3 of the exercise, but can be
 * extended to also test other parts
 */
public class ClassChecks {

	@Test
	public void testOk1() {
		expectOk("class Main { public static void main(String[] args) {} }", "class D {}", "class C extends D {}",
				"class B extends C {}", "class A extends B {}");
	}

	@Test
	public void testOk2() {
		expectOk("class Main { public static void main(String[] args) {} }", "class A extends B {}",
				"class B extends C {}", "class C extends D {}", "class D {}");
	}

	@Test
	public void extendsNonexistingClass() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A extends B {}");
	}

	@Test
	public void extendsMainClass() {
		expectTypeErrors("class B { public static void main(String[] args) {} }", "class A extends B {}");
	}

	@Test
	public void inheritanceCycle1() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A extends A{}");
	}

	@Test
	public void inheritanceCycle2() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A extends B {}",
				"class B extends C {}", "class C extends A {}");
	}

	@Test
	public void inheritanceCycle3() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A extends B {}",
				"class B extends C {}", "class C extends B {}");
	}

	@Test
	public void duplicateClassName() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A {}", "class A {}");
	}

	@Test
	public void duplicateFieldName() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A {", "	boolean x;",
				"	int x;", "}");
	}

	@Test
	public void duplicateMethodName() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A {",
				"	int f() { return 0; }", "	boolean f() { return true; }", "}");
	}
	...
	public void overrideCheck1() {
		expectOk("class Main { public static void main(String[] args) {} }", "class A {",
				"	int f(int x, boolean y) { return 0; }", "}", "class B extends A {",
	...
	public void overrideCheck3() {
		expectOk("class Main { public static void main(String[] args) {} }", "class A {",
				"	A f(A a) { return new A(); }", "}", "class B extends A {", "   B f(A a) { return new B(); }", "}");
	}

	@Test
	public void overrideCheck4() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A {",
				"	B f(A a) { return new B(); }", "}", "class B extends A {", "   A f(A a) { return new A(); }", "}");
	}

	@Test
	public void overrideCheck5() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A {",
				"	A f(B a) { return new B(); }", "}", "class B extends A {", "   A f(A a) { return new A(); }", "}");
	}

	@Test
	public void overrideCheck6() {
		expectTypeErrors("class Main { public static void main(String[] args) {} }", "class A {",
				"	A f(A a) { return new B(); }", "}", "class B extends A {", "   A f(B a) { return new A(); }", "}");
	}

	@Test
	public void argName() {
		expectTypeErrors("class Main { public static void main(String[] args) { int args; } }");
	}
